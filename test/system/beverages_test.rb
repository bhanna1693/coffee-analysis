...
class BeveragesTest < ApplicationSystemTestCase
  ...
  test "creating a Beverage" do
    ...
    fill_in "Beverage", with: @beverage.beverage
    fill_in "Brand", with: @beverage.brand
    fill_in "Caffeine", with: @beverage.caffeine
    fill_in "Calories", with: @beverage.calories
