...
class BeveragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beverage" do
    assert_difference('Beverage.count') do
      post beverages_url, params: { beverage: { beverage: @beverage.beverage, brand: @beverage.brand, caffeine: @beverage.caffeine, calories: @beverage.calories, price: @beverage.price } }
    end
  ...
  test "should update beverage" do
    patch beverage_url(@beverage), params: { beverage: { beverage: @beverage.beverage, brand: @beverage.brand, caffeine: @beverage.caffeine, calories: @beverage.calories, price: @beverage.price } }
